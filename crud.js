...
function renderProduct(products) {
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    tableContent += `<tr>
        <td>${element}</td>
        <td><button onclick="handleEdit(${i})">Edit</button><button onclick="handleEdit2(${i})">Edit 2</button> <button onclick="handleDelete(${i})">Delete</button>
        </td>
      </tr>`;
  }
...
// sadddddd
function notify() {
  // const toastTrigger = document.getElementById("btn-add-edit");
